    ...
    <section className="w-full bg-gray-50 py-16">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <p className="text-lg text-gray-600 leading-relaxed max-w-3xl mb-12">
          ...
          SMS. Below is the most common way to check the Class 12 Result via SMS:
        </p>
          ...
          <div className="flex gap-6">
            ...
            <div>
              <p className="text-gray-700 leading-relaxed">
                ...
                <span className="font-semibold text-gray-900">Class 12 &lt;space&gt; Symbol-Number</span>
              </p>
              <p className="text-gray-600 mt-2">
                Example: <span className="font-semibold text-gray-900">Class 12 3208984</span>
              </p>
            </div>
          </div>
